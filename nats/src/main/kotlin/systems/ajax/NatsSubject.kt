...
object NatsSubject {
    ...
    object Library{
        ...
        const val GET_ALL_WORDS_FROM_LIBRARY = "$LIBRARY_PATH.get_all_words_from_library"
        const val CREATE_NEW_LIBRARY = "$LIBRARY_PATH.create_new_library"
        const val DELETE_LIBRARY = "$LIBRARY_PATH.delete_all_words_from_library"
    }
